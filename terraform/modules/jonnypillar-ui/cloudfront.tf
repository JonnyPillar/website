...
resource "aws_acm_certificate" "jonnypillar_co_uk_cert" {
  provider = aws.us_east
  
  domain_name       = "jonnypillar.co.uk"
  validation_method = "DNS"

  subject_alternative_names = [
    "www.jonnypillar.co.uk"
  ]

  tags = {
    Name        = "jonnypillar.co.uk"
  }
...
resource "aws_cloudfront_distribution" "jonnypillar_co_uk-cf_distribution" {
  ...
  origin {
    ...
    # our S3 bucket.
    domain_name = aws_s3_bucket.jonnypillar_ui_bucket.website_endpoint
    origin_id   = aws_s3_bucket.jonnypillar_ui_bucket.bucket_domain_name
  ...
  aliases             = ["jonnypillar.co.uk", "www.jonnypillar.co.uk"]
  ...
  default_cache_behavior {
    ...
    target_origin_id = aws_s3_bucket.jonnypillar_ui_bucket.bucket_domain_name
  ...
  viewer_certificate {
    ...
    acm_certificate_arn      = aws_acm_certificate.jonnypillar_co_uk_cert.arn
